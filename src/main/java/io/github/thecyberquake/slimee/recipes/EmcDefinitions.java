...
import io.github.thecyberquake.slimee.statics.DebugLogs;
...
public class EmcDefinitions {
    ...
    public EmcDefinitions(SlimeE plugin) {
        fillBase(plugin);
        fillSpecialCases();
        fillExtended(plugin);
        fillEQItems(plugin);
    ...
    private void fillBase(SlimeE plugin) {
    ...
    private void fillExtended(SlimeE plugin) {
    ...
    private void fillEQItems(SlimeE plugin) {
    ...
    private void fillSlimefun(SlimeE plugin) {
    ...
    private Double getSFEmcValue(SlimeE plugin, ItemStack item, Integer nestLevel) {
    ...
    @Nullable
    private Double getEQEmcValue(SlimeE plugin, ItemStack itemStack, Integer nestLevel) {
        if (itemStack != null) {
    ...
    @Nullable
    private Double getEmcValue(SlimeE plugin, ItemStack i, Integer nestLevel) {
    ...
    @Nullable
    private Double checkRecipe(SlimeE plugin, Recipe recipe, Integer nestLevel) {
    ...
    @Nullable
    private  Double checkShaped(SlimeE plugin, ShapedRecipe recipe, int nestLevel) {
    ...
    @Nullable
    private Double checkShapeless(SlimeE plugin, ShapelessRecipe recipe, int nestLevel) {
    ...
    @Nullable
    private Double checkFurnace(SlimeE plugin, FurnaceRecipe recipe, int nestLevel) {
    ...
    @Nullable
    private Double checkStoneCutter(SlimeE plugin, StonecuttingRecipe recipe, int nestLevel) {
    ...
    @Nullable
    private Double checkSmithing(SlimeE plugin, SmithingRecipe recipe, int nestLevel) {
