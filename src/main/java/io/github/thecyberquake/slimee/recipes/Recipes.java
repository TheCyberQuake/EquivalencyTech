package io.github.thecyberquake.slimee.recipes;
...
public class Recipes {
    ...
    public Recipes(SlimeE plugin) {
        addRecipes(plugin);
    }

    private void addRecipes(SlimeE plugin) {
    ...
    public static Recipe recipeCoal1(SlimeE plugin) {
    ...
    public static Recipe recipeCoal2(SlimeE plugin) {
    ...
    public static List<ItemStack> recipeCoal2Check(SlimeE plugin) {
        List<ItemStack> itemStacks = new ArrayList<>();
    ...
    public static Recipe recipeCoal3(SlimeE plugin) {
    ...
    public static List<ItemStack> recipeCoal3Check(SlimeE plugin) {
        List<ItemStack> itemStacks = new ArrayList<>();
    ...
    public static Recipe recipeDarkMatter(SlimeE plugin) {
    ...
    public static List<ItemStack> recipeDarkMatterCheck(SlimeE plugin) {
        List<ItemStack> itemStacks = new ArrayList<>();
    ...
    public static Recipe recipeRedMatter(SlimeE plugin) {
        ItemStack i = plugin.getEqItems().getDarkMatter().getItemClone();
    ...
    public static List<ItemStack> recipeRedMatterCheck(SlimeE plugin) {
        List<ItemStack> itemStacks = new ArrayList<>();
        itemStacks.add(plugin.getEqItems().getAeternalisFuel().getItemClone());
        itemStacks.add(plugin.getEqItems().getAeternalisFuel().getItemClone());
        itemStacks.add(plugin.getEqItems().getAeternalisFuel().getItemClone());
    ...
    public static Recipe recipeTransmutationOrb(SlimeE plugin) {
        ItemStack i = plugin.getEqItems().getDarkMatter().getItemClone();
    ...
    public static List<ItemStack> recipeTransmutationOrbCheck(SlimeE plugin) {
        List<ItemStack> itemStacks = new ArrayList<>();
    ...
    public static List<ItemStack> recipeDissolutionChestCheck(SlimeE plugin) {
        List<ItemStack> itemStacks = new ArrayList<>();
        itemStacks.add(plugin.getEqItems().getMobiusFuel().getItemClone());
        itemStacks.add(plugin.getEqItems().getMobiusFuel().getItemClone());
        itemStacks.add(plugin.getEqItems().getMobiusFuel().getItemClone());
    ...
    public static Recipe recipeDissolutionChest(SlimeE plugin) {
        ItemStack i = plugin.getEqItems().getDarkMatter().getItemClone();
    ...
    public static List<ItemStack> recipeCondensatorChestCheck(SlimeE plugin) {
        List<ItemStack> itemStacks = new ArrayList<>();
        itemStacks.add(plugin.getEqItems().getAeternalisFuel().getItemClone());
        itemStacks.add(plugin.getEqItems().getAeternalisFuel().getItemClone());
        itemStacks.add(plugin.getEqItems().getAeternalisFuel().getItemClone());
    ...
    public static Recipe recipeCondensatorChest(SlimeE plugin) {
        ItemStack i = plugin.getEqItems().getDarkMatter().getItemClone();
    ...
    public static Map<List<ItemStack>, ItemStack> getEQRecipes(SlimeE plugin) {
    ...
    public static List<ItemStack> getEQRecipe(SlimeE plugin, ItemStack itemStack) {
